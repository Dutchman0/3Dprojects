...
const CHARACTER_COLORS = [
  ...
  { skin: 0xf4c8a8, hair: 0x0000ff, dress: 0x0066FF },
];
...
export default function NFTCubeInterface() {
  ...
  useEffect(() => {
    ...
    const pointLight2 = new THREE.PointLight(0x00ffff, 0.4, 50);
    ...
    const edgeGeometry = new THREE.CylinderGeometry(0.03, 0.03, 1.7, 8);
    const edges = [];
    ...
    const faceFrames = [
      { pos: new THREE.Vector3(0, 0, 1.02), rot: new THREE.Euler(0, 0, 0) },
      { pos: new THREE.Vector3(0, 0, -1.02), rot: new THREE.Euler(0, Math.PI, 0) },
      { pos: new THREE.Vector3(1.02, 0, 0), rot: new THREE.Euler(0, Math.PI / 2, 0) },
      { pos: new THREE.Vector3(-1.02, 0, 0), rot: new THREE.Euler(0, -Math.PI / 2, 0) },
      { pos: new THREE.Vector3(0, 1.02, 0), rot: new THREE.Euler(-Math.PI / 2, 0, 0) },
      { pos: new THREE.Vector3(0, -1.02, 0), rot: new THREE.Euler(Math.PI / 2, 0, 0) }
    ];
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black relative overflow-hidden font-sans">
      ...
      {(selectedFace !== null || showVideo) && (
        ...
        >
          <svg className="w-5 h-5 inline mr-2 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5z"></path></svg>
